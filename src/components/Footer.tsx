...
//   const footerLinks = {
//     Product: ['Platform', 'Solutions', 'Pricing', 'Security'],
//     Company: ['About', 'Blog', 'Careers', 'Contact'],
//     Resources: ['Documentation', 'API Docs', 'Support', 'Status'],
...
//               </div>
//               <span className="text-lg font-bold text-foreground">ZORON.AI</span>
//             </div>
...
//           <p className="text-sm text-muted-foreground">
//             © {currentYear} ZORON.AI. All rights reserved.
//           </p>
